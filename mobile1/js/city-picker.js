...
(function (factory) {
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    $this.feedVal();
                    if (last) {
                        $('.ProvincialCityShow').html($this.getVal());
                        $('.ProvincialCity').fadeOut(100);
                    }
                }
    ...
    $(function () {
        ...
        $('.ProvincialCity .cityClose').click(function(){
            var _this = $(this);
            _this.parents('.ProvincialCity').fadeOut(100);
        });
        $('.ProvincialCityOpen').click(function(){
            $('.ProvincialCity').fadeIn(100);
        });
    });
});